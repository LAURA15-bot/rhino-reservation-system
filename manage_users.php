...
<head>
    ...
    <!-- Version bumped to clear browser cache and load Dark Mode logic -->
    <script src="js/manage_users.js?v=3" defer></script>
...
<body class="bg-[#f8fafc] dark:bg-slate-900 text-slate-800 dark:text-slate-200 font-sans antialiased min-h-screen overflow-hidden transition-colors duration-300">
    ...
    <div class="flex h-screen w-screen overflow-hidden">
        ...
        <main class="flex-1 flex flex-col h-full overflow-hidden bg-[#f8fafc] dark:bg-slate-900 transition-colors duration-300">
            ...
            <!-- 3. SCROLLING MAIN CONTENT (Auto-Height Fix Applied) -->
            <div class="flex-1 overflow-y-auto p-4 lg:p-6">
                ...
                <div class="max-w-7xl mx-auto space-y-6">
                    ...
                    <div class="bg-white dark:bg-slate-800 p-5 rounded-2xl custom-shadow border border-slate-100 dark:border-slate-700 flex items-center gap-3 transition-colors duration-300">
                        <div class="w-10 h-10 rounded-xl bg-blue-50 dark:bg-blue-900/30 text-blue-500 dark:text-blue-400 flex items-center justify-center shadow-inner shrink-0">
                    ...
                    <!-- User Table Container (Set to h-auto to prevent stretching) -->
        ...
        <div class="bg-white dark:bg-slate-900 w-full max-w-md rounded-xl shadow-2xl p-8 space-y-6 relative animate-fadeIn border border-slate-100 dark:border-slate-700 transition-colors duration-300">
            ...
            <form id="userProfileForm" onsubmit="submitUserForm(event)" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="display_name" required class="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 p-2.5 rounded text-sm text-slate-800 dark:text-white outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-400 transition-colors duration-300">
                </div>

                <div>
                    <label class="block text-xs font-mono text-slate-500 dark:text-slate-400 mb-1.5">Account Username Identity</label>
                    <input type="text" name="username" required class="w-full bg-blue-50/50 dark:bg-slate-800 border border-slate-200 dark:border-slate-600 p-2.5 rounded text-sm text-slate-800 dark:text-white font-mono outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-400 transition-colors duration-300">
                </div>
                ...
                <div>
                    ...
                    <input type="password" name="password" id="user_password" required class="w-full bg-blue-50/50 dark:bg-slate-800 border border-slate-200 dark:border-slate-600 p-2.5 rounded text-sm text-slate-800 dark:text-white font-mono tracking-widest outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-400 transition-colors duration-300">
                </div>

                <div>
                    <label class="block text-xs font-mono text-slate-500 dark:text-slate-400 mb-1.5">Authority Level Scope</label>
                    <select name="role" id="user_role" required class="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 p-2.5 rounded text-sm text-slate-800 dark:text-white outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-400 transition-colors duration-300 cursor-pointer disabled:bg-slate-100 dark:disabled:bg-slate-900 disabled:text-slate-400 dark:disabled:text-slate-600">
